...
| healenium#88 | invisible/absent elements "healed" | resolve rung: zero matches in the captured DOM rejects before any rerun; give-up is first-class | heal E2E hallucination-offline ✓; **planned: Juice Shop removed-element give-up leg** |
...
| cypress#20458 (closed "use cy.prompt"), #30805 | heal EXISTING suites — demand Cypress redirected to a rewrite | the whole product: unmodified `cy.get` suites healed as reviewed commits | PrairieLearn ✓ 2026-07-03; TodoMVC ✓ 2026-07-04; two more app legs planned |
